...
import 'package:todo_assignment/controllers/todo_controller.dart';
import 'package:todo_assignment/create_todo_view.dart';
import 'package:todo_assignment/utils.dart';
  ...
  loadData() async {
    ...
    await _todoController.getAllTodos().then((todos) {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Todo loaded!')));
    });
  }
